...
Your task is to build a Node.js command-line application that takes in information about employees on a software engineering team, then generates an HTML webpage that displays summaries for each person. Testing is key to making code maintainable, so you’ll need to ensure your code passes each provided test.
...
THEN I am prompted to enter the intern’s name, ID, email, and school, and I am takack to then be menu
